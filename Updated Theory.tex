...
\begin{abstract}
Long COVID presents a diverse array of neurological symptoms \citep{taquet2021neuropsychiatric, reiken2022alzheimersignaling}, including cognitive impairment, fatigue, anhedonia, and dysautonomia. This paper expands on existing hypotheses by proposing an integrated model of dopaminergic-glymphatic dysfunction. We posit that selective infection of dopaminergic neurons in genetically susceptible individuals leads to a self-perpetuating feedback loop between impaired dopamine signaling and glymphatic clearance. Specifically, variants in ACE2, TMPRSS2, DRD2, and DAT1 may influence the likelihood \citep{novelli2020ace2variants, asselta2020ace2tmprss2} of SARS-CoV-2 entry into dopamine-producing cells, while variants affecting aquaporin-4 channels may impair glymphatic function \citep{boespflug2018, Mestre2020}. The resulting dysfunction manifests as reduced dopamine availability and inefficient metabolic waste clearance, leading to movement disorders, motivational deficits, and executive dysfunction—symptoms that strongly correlate with Long COVID manifestations \citep{davis2021longcovidcohort, graham2021longcovidneuro}. This bidirectional model elegantly explains the persistence, fluctuation, and post-exertional worsening of neurological symptoms. We present supporting evidence, propose testable predictions, and discuss implications for targeted therapeutic strategies.
\end{abstract}
...
Cognitive impairment ("brain fog") could stem from mesocortical pathway dysfunction affecting prefrontal cortex function, accumulation of metabolic waste in prefrontal regions due to impaired glymphatic clearance, and increased cognitive effort requirements due to dopaminergic and glymphatic dysfunction.
...
\bibliography{references_complete_merged_final.bib}
